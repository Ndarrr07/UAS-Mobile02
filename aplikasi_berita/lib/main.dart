            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Text(
                      'Jose Mourinho tercatat sebagai salah satu pelatih tersukses sepanjang masa. Selama menjadi pelatih, Mourinho kerap mendatangkan pemain dengan harga tinggi.${index + 1}'),
                  onTap: () {
